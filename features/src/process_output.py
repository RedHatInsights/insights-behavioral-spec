...
def filepath_from_context(context: Context, prefix: str = "", suffix: str = "", max_len=200) -> str:
    """
    Returns a filepath like {prefix}{feature_name}_{scenario_name}{suffix}.log.
...
def process_generated_output(context: Context, out, return_code=None, stdout_file=None, stderr_file=None):

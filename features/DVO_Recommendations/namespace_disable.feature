Feature: it is expected that customers will see some false positives for
  ...
  Scenario: Disable DVO recommendation for one actually selected cluster in Insights Advisor
    Given user USER1 is part of account (organization) ACCOUNT1
      And account (organization) ACCOUNT1 owns 1 cluster
      And the cluster name is 11111111-2222-3333-4444-555555555555
      And the user USER1 is already logged in into Hybrid Cloud Console
     ...
     Then the dialog should disappear
      ...
      And that page should contain following controls and widgets
          | Control/widget  | Content                                    |
          | Recommendations | Section containing list of recommendations |
      And table "Recommendations" should contain following five columns in that order
          | Column         | Comment                                                  |
          | Expand button  |                                                          |
          | Cluster name   |                                                          |
          | App name       | app real name or UID depending on anonymization settings |
  ...
  Scenario: Disable DVO recommendation for all clusters in Insights Advisor
    Given user USER1 is part of account (organization) ACCOUNT1
      And account (organization) ACCOUNT1 owns 1 cluster
      And the cluster name is 11111111-2222-3333-4444-555555555555
      And the user USER1 is already logged in into Hybrid Cloud Console
  ...
  Scenario: Provide justification when disabling DVO recommendation for one selected cluster in Insights Advisor
    Given user USER1 is part of account (organization) ACCOUNT1
      And account (organization) ACCOUNT1 owns 1 cluster
      And the cluster name is 11111111-2222-3333-4444-555555555555
      And the user USER1 is already logged in into Hybrid Cloud Console
  ...
  Scenario: Provide justification when disabling DVO recommendation for all clusters in Insights Advisor
    Given user USER1 is part of account (organization) ACCOUNT1
      And account (organization) ACCOUNT1 owns 1 cluster
      And the cluster name is 11111111-2222-3333-4444-555555555555
      And the user USER1 is already logged in into Hybrid Cloud Console

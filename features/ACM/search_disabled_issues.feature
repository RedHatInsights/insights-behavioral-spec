Feature: Search for issues in case some or all issues are disabled in Insights Advisor


  Scenario: Ability to search for issues on Advanced Cluster Management for one local cluster (1 rule disabled)
    Given user USER1 is part of account (organization) ACCOUNT1
      ...
      And 1 other critical issue is detected for this cluster

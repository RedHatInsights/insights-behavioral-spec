Feature: Filtering on Advisor recommendations page behaviour on Hybrid Cloud Console
  ...
  Scenario: Set filter "Name" on Displaying Advisor's "Recommendations" page on Hybrid Cloud Console with at least one recommendation and two clusters
    Given user USER1 is part of account (organization) ACCOUNT1
      And account (organization) ACCOUNT1 owns 2 clusters
          | Cluster name                         |
          | 00000000-0000-0000-0000-000000000000 |
     ...
     Then table with several columns should be displayed
          ...
          | Total risk  |
          | Clusters    |
      And that table should contain at 1 row
          | Name        | Added       | Total risk | Clusters |
          | Abc12345    | 10 days ago | Important  | 0        |
      And one filter needs to be preselenced
          | Filter name | Tag     |
  ...
  Scenario: Set filter "Total risk" on Displaying Advisor's "Recommendations" page on Hybrid Cloud Console with at least one recommendation and two clusters
    Given user USER1 is part of account (organization) ACCOUNT1
      And account (organization) ACCOUNT1 owns 2 clusters
          | Cluster name                         |
          | 00000000-0000-0000-0000-000000000000 |
  ...
  Scenario: Set filter "Clusters impacted" on Displaying Advisor's "Recommendations" page on Hybrid Cloud Console with at least one recommendation and two clusters
    Given user USER1 is part of account (organization) ACCOUNT1
      And account (organization) ACCOUNT1 owns 2 clusters
          | Cluster name                         |
          | 00000000-0000-0000-0000-000000000000 |

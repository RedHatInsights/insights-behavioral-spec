...
Feature: Ability to export tables into S3
  ...
  @database @s3 @export
  Scenario: Check export empty tables into S3/Minio with record limit explicitly set
  ...
  @database @s3 @export
  Scenario: Check export from REPORT table into S3/Minio with record limit explicitly set
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @s3 @export
  Scenario: Check export from ADVISOR_RATINGS table into S3/Minio with record limit explicitly set
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @s3 @export
  Scenario: Check export from CLUSTER_RULE_TOGGLE table into S3/Minio with record limit explicitly set
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @s3 @export
  Scenario: Check export from CLUSTER_RULE_USER_FEEDBACK table into S3/Minio with record limit explicitly set
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @s3 @export
  Scenario: Check export from CLUSTER_USER_RULE_DISABLE_FEEDBACK table into S3/Minio with record limit explicitly set
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @s3 @export
  Scenario: Check export from RULE_HIT table into S3/Minio with record limit explicitly set
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @s3 @export
  Scenario: Check export from RECOMMENDATION table into S3/Minio with record limit explicitly set
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @s3 @export
  Scenario: Check export from MIGRATION_INFO table into S3/Minio with record limit explicitly set
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @s3 @export
  Scenario: Check export from CONSUMER_ERROR table into S3/Minio with record limit explicitly set
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @s3 @export
  Scenario: Check export from REPORT_INFO table into S3/Minio with record limit explicitly set
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @s3 @export
  Scenario: Check export from RULE_DISABLE table into S3/Minio with record limit explicitly set
     When I prepare database schema
     Then I should find that all tables are empty

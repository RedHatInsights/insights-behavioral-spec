...
Feature: Ability to export tables into file with max limit of records set
  ...
  Scenario: Check export empty tables into file with record limit explicitly set to 2
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from REPORT table with record limit explicitly set to 2
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from ADVISOR_RATINGS table with record limit explicitly set to 2
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from CLUSTER_RULE_TOGGLE table with record limit explicitly set to 2
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from CLUSTER_RULE_USER_FEEDBACK table with record limit explicitly set to 2
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from CLUSTER_USER_RULE_DISABLE_FEEDBACK table with record limit explicitly set to 2
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from RULE_HIT table with record limit explicitly set to 2
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from RECOMMENDATION table with record limit explicitly set to 2
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from MIGRATION_INFO table with record limit explicitly set to 2
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from CONSUMER_ERROR table with record limit explicitly set to 2
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from REPORT_INFO table with record limit explicitly set to 2
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from RULE_DISABLE table with record limit explicitly set to 2
     When I prepare database schema
     Then I should find that all tables are empty
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export empty tables into file with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I run the exporter with the following command line flags: --output file --limit 0
     Then The process should finish with exit code 0
      And I should see following files generated
          | File name                              |
          | advisor_ratings.csv                    |
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from REPORT table with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I insert following records into REPORT table
          | org_id | cluster                              | report | reported_at  |
          ...
          | 2      | 5d5892d4-1f74-4ccf-91af-548dfc9767ac |        | 2100-01-01   |
          | 2      | 5d5892d4-1f74-4ccf-91af-548dfc9767ad |        | 2100-01-01   |
      And I run the exporter with the following command line flags: --output file --limit 0
     Then The process should finish with exit code 0
      And I should see following files generated
          | File name                              |
          | advisor_ratings.csv                    |
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from ADVISOR_RATINGS table with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I insert following records into ADVISOR_RATINGS table
          | org_id | user_id | rule_fqdn    | error_key | rule_id  |
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from CLUSTER_RULE_TOGGLE table with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I insert following records into CLUSTER_RULE_TOGGLE table
          | cluster_id                           | user_id | disabled | updated_at | error_key | rule_id  |
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from CLUSTER_RULE_USER_FEEDBACK table with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I insert following records into CLUSTER_RULE_USER_FEEDBACK table
          | cluster_id                           | user_id | user_vote | message   | added_at   | updated_at | error_key | rule_id  |
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from CLUSTER_USER_RULE_DISABLE_FEEDBACK table with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I insert following records into CLUSTER_USER_RULE_DISABLE_FEEDBACK table
          | cluster_id                           | user_id | message   | added_at   | updated_at | error_key | rule_id  |
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from RULE_HIT table with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I insert following records into RULE_HIT table
          | org_id | cluster_id                           | rule_fqdn    | error_key | template_data |
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from RECOMMENDATION table with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I insert following records into RECOMMENDATION table
          | org_id | cluster_id                           | rule_fqdn    | error_key | rule_id |
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from MIGRATION_INFO table with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I insert following records into MIGRATION_INFO table
          | version |
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from CONSUMER_ERROR table with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I insert following records into CONSUMER_ERROR table
          | topic | partition | topic_offset | key | produced_at | consumed_at | message  | error  |
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from REPORT_INFO table with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I insert following records into REPORT_INFO table
          | org_id | cluster_id                           | version_info |
  ...
  @database @file @export @database-read @database-write
  Scenario: Check export from RULE_DISABLE table with limit explicitly set to zero
     When I prepare database schema
     Then I should find that all tables are empty
     When I insert following records into RULE_DISABLE table
          | org_id | user_id | rule_id | error_key | justification  |

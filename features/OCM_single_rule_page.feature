Feature: Single rule page in OCM UI

  Scenario: Displaying single rule page in OCM UI
    Given console.redhat.com is accessible
     ...
     When user selects "How to remediate" tab header
     Then a section with remediations should be displayed
      And an optional link to Knowledge base or to other document might be displayed
     When user selects "Reason" tab header
     Then a section with reasons should be displayed
      And an optional link to Knowledge base or to other document might be displayed
